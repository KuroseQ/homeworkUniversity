...
public class HomeWork7 {
    ...
    public static List<String> methodOne(List<String> names) {
        // Твой код здесь
        return names.stream().filter(name -> name.matches(".*King.*")).toList();
    }
    ...
    public static List<String> methodTwo(List<String> names) {
        // Твой код здесь
        return names.stream().map(lastName -> lastName.substring(lastName.indexOf(" ") + 1))
                .distinct().toList();
    }
    ...
    public static List<String> methodThree(List<String> names) {
        // Твой код здесь
        return names.stream().map(firstName -> firstName.substring(0, firstName.indexOf(" "))).distinct()
                .filter(firstName -> firstName.matches("L.+")).toList();
    }
    ...
    public static List<String> methodFour(List<String> names) {
        // Твой код здесь
        return names.stream().map(lastName -> lastName.substring(lastName.indexOf(" ") + 1))
                .distinct().filter(lastName -> lastName.matches("W.+")).sorted().toList();
    }
    ...
    public static Integer methodFive(List<String> names) {
        // Твой код здесь
        return Math.toIntExact(names.stream().map(firstName -> firstName.substring(0, firstName.indexOf(" ")))
                .distinct().filter(firstName -> firstName.length() > 6).count());
    }
    ...
    public static Integer methodSix(List<String> names) {
        // Твой код здесь
        return Math.toIntExact(Stream.concat(
                        names.stream().map(firstName -> firstName.substring(0, firstName.indexOf(" "))),
                        names.stream().map(lastName -> lastName.substring(lastName.indexOf(" ") + 1)))
                .filter(lastName -> lastName.length() > 5).distinct().count());
    }
    ...
    public static List<String> methodSeven(List<String> names) {
        // Твой код здесь
        return names.stream().map(name -> name.substring(0, name.indexOf(" ") + 2))
                .filter(name -> (name.endsWith("K")) || (name.endsWith("S")))
                .map(name -> name.concat(".")).distinct().sorted().toList();
    }
